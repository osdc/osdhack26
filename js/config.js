  ...
  menuItems: [
    ...
    },
    {
      ...
      popup: {
        ...
        body: '<div class="modal-section"><div class="modal-section-title">Official Rulebook</div><p>The complete participant handbook is available as a downloadable PDF.</p></div><div class="modal-section"><a class="modal-retro-btn" href="/rulebook" target="_blank">OPEN RULEBOOK</a></div><div class="modal-ending">Read it before you hack.</div>'
      },
